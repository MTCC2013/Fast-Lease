 ...
 */
public class JanelaRelatorioCategoria extends javax.swing.JFrame {

    private CategoriaTabelModel modelo;

    public JanelaRelatorioCategoria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        painelCabecalhoCliente1Layout.setHorizontalGroup(
            ...
            .add(painelCabecalhoCliente1Layout.createSequentialGroup()
                ...
                .add(labelNomeRelFun)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(campoNomeRelFun, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 144, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
   ...
   /**
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        JanelaCadastroCategoria jc = new JanelaCadastroCategoria(modelo);
        jc.setVisible(true);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            JanelaEditarCategoria ac = new JanelaEditarCategoria(selecionado, cdModelo, modelo);
            ac.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "É necessário selecionar uma linha");
        }
