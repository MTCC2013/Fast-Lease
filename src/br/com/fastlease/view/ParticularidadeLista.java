 ...
 */
public class ParticularidadeLista extends javax.swing.JFrame {

    private ParticularidadeTableModel model;

    public ParticularidadeLista() {

        initComponents();
        setExtendedState(javax.swing.JFrame.MAXIMIZED_BOTH);
        List<Particularidade> lista = new ArrayList<Particularidade>();
        ParticularidadeController a = new ParticularidadeController();
        lista = a.buscarParticularidade();

        //cria o modelo de Produto      
        model = new ParticularidadeTableModel(lista);

        //atribui o modelo à tabela
        tabelaParticularidade.setModel(model);

        // Ordenar tabela conforme cabeçalho coluna clicado.
        tabelaParticularidade.setAutoCreateRowSorter(true);
    ...
    private void initComponents() {
        ...
        tabelaParticularidade = new javax.swing.JTable();
        ...
        labelCadCliente1.setText("PARTICULARIDADE");
        ...
        tabelaParticularidade.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabelaParticularidade);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            ParticularidadeEditar am = new ParticularidadeEditar(selecionado, cdModelo, model);
            am.setVisible(true);
        } else {
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        ...
        ParticularidadeInserir jc = new ParticularidadeInserir(model);
        jc.setVisible(true);
    ...
    private void efetuaPesquisa() {
        ...
        List<Particularidade> lista = new ArrayList<Particularidade>();
        ParticularidadeController a = new ParticularidadeController();
        lista = a.buscarParticularidadebyNome(nome);
        model.limpar();
    ...
    private javax.swing.JTable tabelaParticularidade;
