 ...
 */
public class CursoInserir extends javax.swing.JFrame {
    //Declara tabelmodel

    CursoTabelModel model;

    public CursoInserir(CursoTabelModel mtb) {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        cbCategoria.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Técnico", "Superior", "Aprendizagem Industrial", "EaD" }));
            ...
            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                ...
                .addGroup(abaCadastroCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                        ...
                        .addGroup(abaCadastroCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                                .addComponent(cbFase, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        labelCadCliente1.setText("CADASTRO DE CURSO");
                ...
                .addGroup(painelCabecalhoCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelCabecalhoCliente1Layout.createSequentialGroup()
                        .addGroup(painelCabecalhoCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btApagarFun)
                            .addComponent(labelCadCliente1, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(34, 34, 34))))
        );
        ...
        if (campoCurso.getText().length() <= 0 || campoDuracao.getText().length() <= 0) {
            ...
            Curso cursoinserido = pesquisar(f.getCurso());
                if (cursoinserido != null) {
                    ...
                    fc.inserir(f);
                    model.addCurso(pesquisar(f.getCurso()));
                    dispose();
                }
