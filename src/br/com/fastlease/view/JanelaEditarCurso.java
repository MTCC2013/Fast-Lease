 ...
 * @author Mauricio
 */
public class JanelaEditarCurso extends javax.swing.JFrame {

    int linhaSelecionada;
    int idCurso;
    CursoTabelModel modelo;

    public JanelaEditarCurso(int selecionado, int cdModelo, CursoTabelModel mtb) {
        initComponents();
        ...
        carregarCombo(c.getCategoria().getCodigo());
                    ...
                    .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                        ...
                        .addGroup(abaCadastroCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                                ...
                                .addComponent(campoDataTermino, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
    ...
    private void carregarCombo(int cdCategoria) {
        ...
        for (int linha = 0; linha < categorias.size(); linha++) {
            ...
            if (categoria.getCodigo() == cdCategoria) {
