 ...
 */
public class CargoInserir extends javax.swing.JFrame {
    //Declarando tabelmodel

    CargoTabelModel model;

    public CargoInserir(CargoTabelModel mtb) {
        initComponents();
        setResizable(false);
        setLocationRelativeTo(null);
        //Inicializando tabelmodel
        model = mtb;
    ...
    private void initComponents() {
        ...
        labelNomeCadCliente1.setText("Cargo:");
        ...
        abaCadastroCliente1Layout.setHorizontalGroup(
            ...
            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                ...
                .addComponent(campoCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 396, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        labelCadCliente1.setText("CADASTRO DE CARGO");
        ...
        painelCabecalhoCliente1Layout.setVerticalGroup(
            ...
            .addGroup(painelCabecalhoCliente1Layout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(labelCadCliente1, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    //Método botão cadastro
    private void btCadastroFunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastroFunActionPerformed

        Cargo f = new Cargo();
        //Valida se o campo está vazio, então não podera realizar o cadastro
        if (campoCargo.getText().length() > 0) {
            f.setCargo(campoCargo.getText());
            CargoController fc = new CargoController();
            fc.inserir(f);
            //Insere o cargo apenas se a transação for concluida
            Cargo cargoinserir = pesquisar(f.getCargo());
            if (cargoinserir != null) {
                //Adiciona o cargo a tabela
                model.addCargo(pesquisar(f.getCargo()));
    ...
    private Cargo pesquisar(String area) {
        CargoController cc = new CargoController();
        return cc.buscarCargobyNom(area);
    }
