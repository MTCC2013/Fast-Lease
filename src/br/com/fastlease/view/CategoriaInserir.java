 ...
 * @author Mauricio
 */
public class CategoriaInserir extends javax.swing.JFrame {

    CategoriaTabelModel model;

    public CategoriaInserir(CategoriaTabelModel mtb) {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        labelNomeCadCliente1.setText("Categoria:");
        ...
        abaCadastroCliente1Layout.setHorizontalGroup(
            ...
            .addGroup(abaCadastroCliente1Layout.createSequentialGroup()
                ...
                .addComponent(campoCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 396, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        labelCadCliente1.setText("CADASTRO DE CATEGORIA");
                ...
                .addGroup(painelCabecalhoCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, painelCabecalhoCliente1Layout.createSequentialGroup()
                        .addGroup(painelCabecalhoCliente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btApagarFun)
                            .addComponent(labelCadCliente1, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(34, 34, 34))))
        );
    ...
    private void btCadastroFunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastroFunActionPerformed
        ...
        if (campoCategoria.getText().length() > 0) {
            ...
            fc.inserir(f);
            Categoria categoriainserida = pesquisar(f.getCategoria());
