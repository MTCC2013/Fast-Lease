 ...
 */
public class JanelaRelatorioCargo extends javax.swing.JFrame {

    private CargoTabelModel modelo;

    public JanelaRelatorioCargo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        painelCabecalhoCliente1Layout.setHorizontalGroup(
            ...
            .add(painelCabecalhoCliente1Layout.createSequentialGroup()
                ...
                .add(labelNomeRelFun)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(campoNomeRelFun, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 161, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
   ...
   /**
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        JanelaCadastroCargo jc = new JanelaCadastroCargo(modelo);
        jc.setVisible(true);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            JanelaEditarCargo ac = new JanelaEditarCargo(selecionado, cdModelo, modelo);
            ac.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "É necessário selecionar uma linha");
        }
