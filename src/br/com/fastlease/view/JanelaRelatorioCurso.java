 ...
 */
public class JanelaRelatorioCurso extends javax.swing.JFrame {

    private CursoTabelModel model;

    public JanelaRelatorioCurso() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabArea.getColumnModel().getColumn(0).setResizable(false);
        tabArea.getColumnModel().getColumn(0).setPreferredWidth(50);
        tabArea.getColumnModel().getColumn(1).setResizable(false);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            JanelaEditarCurso ac = new JanelaEditarCurso(selecionado, cdModelo, model);
            ac.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(null, "É necessário selecionar uma linha");
        }
    ...
    private void btInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInserirActionPerformed
        JanelaCadastroCurso jc = new JanelaCadastroCurso(model);
        jc.setVisible(true);
